...
public class YgInfoFragment extends Fragment{
    TextView marketurl;
    String URL = "http://ygkplus.com/";
    public YgInfoFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         View layout = inflater.inflate(R.layout.fragment_yg_info, container, false);
