...
public class BazzarReviewFragment extends Fragment implements View.OnClickListener{
    ImageView image_review_change;
    String name,msg;

    public BazzarReviewFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_bazzar_review, container, false);
        try
        {
