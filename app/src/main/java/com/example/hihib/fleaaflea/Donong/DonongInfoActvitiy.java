package com.example.hihib.fleaaflea.Donong;
...
public class DonongInfoActvitiy extends AppCompatActivity implements View.OnClickListener{
    ...
    final Fragment fragment_info = new DonongInfoFragment();
    final Fragment fragment_review = new DonongReviewFragment();
    ...
    void getToolbar()
    {
        ...
        vp.setAdapter(new DonongInfoActvitiy.pagerAdapter(getSupportFragmentManager()));
//        vp.setCurrentItem(0);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_market_report:
                    it = new Intent(DonongInfoActvitiy.this , MainActivity.class);
                    it.putExtra("item",0);
                    startActivity(it);
                    finish();
                    return true;
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.main_page_submit:
                Intent it = new Intent(DonongInfoActvitiy.this , MainActivity.class);
                startActivity(it);
                finish();
                break;
            //test
