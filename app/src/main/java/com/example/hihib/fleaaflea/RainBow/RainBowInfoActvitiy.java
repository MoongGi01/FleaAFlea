...
public class RainBowInfoActvitiy extends AppCompatActivity implements View.OnClickListener{
    ...
    final Fragment fragment_info = new RainBowInfoFragment();
    final Fragment fragment_review = new RainBowReviewFragment();
    ...
    void getToolbar()
    {
        ...
        vp.setAdapter(new RainBowInfoActvitiy.pagerAdapter(getSupportFragmentManager()));
//        vp.setCurrentItem(0);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_market_report:
                    it = new Intent(RainBowInfoActvitiy.this , MainActivity.class);
                    it.putExtra("item",0);
                    startActivity(it);
                    finish();
                    return true;
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.main_page_submit:
                Intent it = new Intent(RainBowInfoActvitiy.this , MainActivity.class);
                startActivity(it);
                finish();
                break;
            //test
