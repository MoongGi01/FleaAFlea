package com.example.hihib.fleaaflea.CityMarket;
...
public class CityMarketInfoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    final Fragment fragment_info = new CityMarketInfoFragment();
    final Fragment fragment_review = new CityMarketReviewFragment();
    ...
    void getToolbar()
    {
        ...
        vp.setAdapter(new CityMarketInfoActivity.pagerAdapter(getSupportFragmentManager()));
//        vp.setCurrentItem(0);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_market_report:
                    it = new Intent(CityMarketInfoActivity.this , MainActivity.class);
                    it.putExtra("item",0);
                    startActivity(it);
                    finish();
                    return true;
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.main_page_submit:
                Intent it = new Intent(CityMarketInfoActivity.this , MainActivity.class);
                startActivity(it);
                finish();
                break;
            //test
