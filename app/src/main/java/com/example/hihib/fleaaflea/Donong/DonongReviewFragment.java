...
public class DonongReviewFragment extends Fragment implements View.OnClickListener{
    ImageView image_review_change;
    String name,msg;

    public DonongReviewFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.donong_fragment_review, container, false);
        try
        {
