...
public class GangNamActivity extends AppCompatActivity implements View.OnClickListener{
...
//                  mPopWindow.showAtLocation(popupView, Gravity.CENTER, 0, 0);
                    ...
                    Context context;
                    Intent it = new Intent(GangNamActivity.this , ThemaPopupActivity.class);
                    startActivity(it);
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.main_page_submit:
                Intent it = new Intent(GangNamActivity.this , MainActivity.class);
                startActivity(it);
                finish();
                break;
        }
