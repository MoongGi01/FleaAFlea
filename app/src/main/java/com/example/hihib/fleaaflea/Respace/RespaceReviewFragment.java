...
public class RespaceReviewFragment extends Fragment implements View.OnClickListener{
    ImageView image_review_change;
    String name,msg;

    public RespaceReviewFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.respace_fragment_review, container, false);
        try
        {
